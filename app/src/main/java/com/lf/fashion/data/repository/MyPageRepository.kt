...
class MyPageRepository @Inject constructor(
    ...
    suspend fun updateMyProfile(
      ...
      //  val profileImagePart = profileImage?.toRequestBody("text/plain".toMediaTypeOrNull())
        val requestBody = profileImage?.asRequestBody("image/*".toMediaTypeOrNull())
        val profileImagePart =
            if (requestBody == null) {
                null
            } else {
                MultipartBody.Part.createFormData("avartar", profileImage.name, requestBody)
            }
         /*  profileImage?.let {
               MultipartBody.Part.createFormData("avartar", null, profileImage)
           }*/
